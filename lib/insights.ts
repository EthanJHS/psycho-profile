  ...
  const pool: (CharacterStrength & { score: number })[] = [
    {
      ...
      shadow: '탐구에 몰입하다 실행이 늦어지거나, 결론 없이 계속 파고드는 "분석 마비"에 빠질 수 있습니다. 충분히 알기 전에는 시작하지 못하는 패턴을 경계하세요.',
    },
    {
      ...
      shadow: '기준이 너무 높아 완벽주의로 이어지거나, 타인에게도 같은 수준을 무의식적으로 요구할 수 있습니다. "충분히 좋은" 기준을 의식적으로 설정하는 연습이 필요합니다.',
    },
    {
      ...
      shadow: '솔직함이 배려 없는 직설로 받아들여지거나, 경청보다 주도하려는 경향이 강해질 수 있습니다. 발언 전에 상대의 수용 준비가 됐는지 확인하는 습관이 도움이 됩니다.',
    },
    {
      ...
      shadow: '타인의 불투명함이나 전략적 행동에 지나치게 민감해지거나, 사소한 불일치도 신뢰 문제로 확대 해석할 수 있습니다. 모든 상황에 동일한 투명성 기준을 요구하면 관계에서 피로가 쌓입니다.',
    },
    {
      ...
      shadow: '타인의 감정을 너무 많이 흡수해 감정 소진(compassion fatigue)이 오거나, 자신의 필요는 뒤로 미루는 패턴이 반복될 수 있습니다. "돌보되 잃지 않기" 위한 경계 설정이 핵심입니다.',
    },
    {
      ...
      shadow: '데이터와 논리 중심으로 접근하다 감정적 맥락을 놓치거나, 분석이 길어져 의사결정이 늦어질 수 있습니다. 때로는 불완전한 정보로 빠르게 결정하는 연습이 필요합니다.',
    },
    {
      ...
      shadow: '과도하면 자기 확신 부족으로 이어져, 충분한 능력이 있어도 의견을 내기를 주저할 수 있습니다. "나도 틀릴 수 있다"와 "내 판단을 믿는다"는 동시에 성립합니다.',
    },
    {
      ...
      shadow: '손절해야 할 상황에서도 버티는 "매몰비용 오류"에 빠질 수 있습니다. 끈기와 고집을 구분하는 기준 — "이 방향이 여전히 맞는가?" — 를 주기적으로 점검하세요.',
    },
    {
      ...
      shadow: '아이디어가 넘쳐 실행 전에 다음 아이디어로 넘어가거나, 기존 방식을 불필요하게 복잡하게 바꾸려는 충동이 생길 수 있습니다. 아이디어를 완성까지 끌고 가는 파트너와 협업하면 시너지가 납니다.',
    },
    {
      ...
      shadow: '갈등 회피를 위해 자신의 의견을 지나치게 양보하거나, 결정이 필요한 순간에 중립을 고수해 리더십 공백이 생길 수 있습니다. 조화는 "모두가 이기는 것"이지 "내가 지는 것"이 아닙니다.',
    },
  ]
